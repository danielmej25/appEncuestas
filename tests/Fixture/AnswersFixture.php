...
class AnswersFixture extends TestFixture
{
    ...
    public $fields = [
        'id_answer' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'answers_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_question'], 'references' => ['questions', 'id_question'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
