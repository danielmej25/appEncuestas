...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'password' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'role' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'username' => '7c7558ca-5f58-4ae6-bb7c-83f5c71765e0',
                'password' => 'Lorem ipsum dolor sit amet',
                'first_name' => 'Lorem ipsum dolor sit amet',
                'last_name' => 'Lorem ipsum dolor sit amet',
                'role' => 'Lorem ipsum dolor sit amet',
                'active' => 1,
                'created' => '2020-02-19 19:50:03',
                'modified' => '2020-02-19 19:50:03',
            ],
        ];
        parent::init();
    }
